...
public class Game {
    ...
    public Game(String red1, String red2, String red3, String red4, String blue1, String blue2, String blue3, String blue4,
...
//                        player.getFiguresPositions()[i + confirmedRoll].setPosition(i + confirmedRoll);
                        ...
                        //                check if kick other player
                        if (!globalPositions[Integer.parseInt((player.getPlayerBoard()[i + confirmedRoll]))].getName().equals("0")) {
                        ...
                        if (i + confirmedRoll < 41) {
                            ...
                            globalPositions[Integer.parseInt(player.getPlayerBoard()[i + confirmedRoll])] = newGlobalPosition;
                        } else {
