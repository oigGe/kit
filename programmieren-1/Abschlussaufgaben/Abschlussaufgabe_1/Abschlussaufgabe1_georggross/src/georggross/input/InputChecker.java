...
public final class InputChecker {
     ...
     * Checks if the last char of user input is whitespace.
     * Checks if input has consececutive whitespaces
     *
     * @param input - user input
     * @return - returns null if no violations were found, otherwise returns
    ...
    /**
     * Checks if user complex input has the correct format.
     *
     * @param input - user input
     * @return - true if valid complex input
     */
